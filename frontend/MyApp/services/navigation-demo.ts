...
export const DEMO_ROOMS: DemoRoom[] = [
  createRoom("ENG B1", "B", 18, 18, 10, 12, "B_WEST", "service"),
  createRoom("ENG B2", "B", 56, 18, 14, 10, "B_CENTER", "service"),
  createRoom("ENG B9", "B", 72, 18, 18, 10, "B_EAST", "lab"),
...
export const FLOOR_FEATURES: Record<DemoFloorId, DemoFloorFeature[]> = {
  B: [
    { fill: "#e7edf6", points: [{ x: 14, y: 10 }, { x: 92, y: 10 }, { x: 92, y: 78 }, { x: 14, y: 78 }] },
    { fill: "#d8e1ee", points: [{ x: 42, y: 30 }, { x: 88, y: 30 }, { x: 88, y: 74 }, { x: 42, y: 74 }] },
  ],
  LG: [
    { fill: "#e7edf6", points: [{ x: 8, y: 8 }, { x: 96, y: 8 }, { x: 96, y: 74 }, { x: 8, y: 74 }] },
    { fill: "#d7dfec", points: [{ x: 8, y: 34 }, { x: 96, y: 34 }, { x: 96, y: 42 }, { x: 8, y: 42 }] },
    { fill: "#dde5f1", points: [{ x: 58, y: 36 }, { x: 88, y: 36 }, { x: 88, y: 64 }, { x: 58, y: 64 }] },
  ],
  "1": [
    { fill: "#e7edf6", points: [{ x: 8, y: 8 }, { x: 96, y: 8 }, { x: 96, y: 74 }, { x: 8, y: 74 }] },
    { fill: "#d7dfec", points: [{ x: 8, y: 20 }, { x: 96, y: 20 }, { x: 96, y: 28 }, { x: 8, y: 28 }] },
    { fill: "#dce5f2", points: [{ x: 52, y: 10 }, { x: 60, y: 10 }, { x: 60, y: 42 }, { x: 52, y: 42 }] },
    { fill: "#dbe4f0", points: [{ x: 24, y: 36 }, { x: 68, y: 36 }, { x: 68, y: 42 }, { x: 24, y: 42 }] },
    { fill: "#dce4f1", points: [{ x: 64, y: 20 }, { x: 96, y: 20 }, { x: 96, y: 72 }, { x: 64, y: 72 }] },
  ],
  "2": [
    { fill: "#e7edf6", points: [{ x: 4, y: 8 }, { x: 96, y: 8 }, { x: 96, y: 74 }, { x: 4, y: 74 }] },
    { fill: "#d7dfec", points: [{ x: 4, y: 20 }, { x: 96, y: 20 }, { x: 96, y: 28 }, { x: 4, y: 28 }] },
    { fill: "#dce4f1", points: [{ x: 52, y: 10 }, { x: 60, y: 10 }, { x: 60, y: 38 }, { x: 52, y: 38 }] },
    { fill: "#d9e2ef", points: [{ x: 16, y: 36 }, { x: 78, y: 36 }, { x: 78, y: 42 }, { x: 16, y: 42 }] },
    { fill: "#dbe4f1", points: [{ x: 76, y: 18 }, { x: 96, y: 18 }, { x: 96, y: 68 }, { x: 76, y: 68 }] },
  ],
  "3": [
    { fill: "#e7edf6", points: [{ x: 4, y: 8 }, { x: 96, y: 8 }, { x: 96, y: 74 }, { x: 4, y: 74 }] },
    { fill: "#d8e0ed", points: [{ x: 4, y: 24 }, { x: 96, y: 24 }, { x: 96, y: 32 }, { x: 4, y: 32 }] },
    { fill: "#dbe4f1", points: [{ x: 62, y: 10 }, { x: 96, y: 10 }, { x: 96, y: 38 }, { x: 62, y: 38 }] },
  ],
  "4": [
    { fill: "#e7edf6", points: [{ x: 4, y: 10 }, { x: 96, y: 10 }, { x: 96, y: 74 }, { x: 4, y: 74 }] },
    { fill: "#d8e0ed", points: [{ x: 4, y: 24 }, { x: 96, y: 24 }, { x: 96, y: 32 }, { x: 4, y: 32 }] },
    { fill: "#dbe3f0", points: [{ x: 66, y: 12 }, { x: 96, y: 12 }, { x: 96, y: 38 }, { x: 66, y: 38 }] },
  ],
  "5": [
    { fill: "#e7edf6", points: [{ x: 10, y: 14 }, { x: 96, y: 14 }, { x: 96, y: 72 }, { x: 10, y: 72 }] },
    { fill: "#d8e0ed", points: [{ x: 10, y: 34 }, { x: 96, y: 34 }, { x: 96, y: 42 }, { x: 10, y: 42 }] },
    { fill: "#dce4f1", points: [{ x: 54, y: 14 }, { x: 96, y: 14 }, { x: 96, y: 64 }, { x: 54, y: 64 }] },
  ],
};
